  ...
  <main class="container mx-auto p-4 mt-4">
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
      ...
      <form method="POST" action="{{route('jobs.update', $job->id)}}"
        ...
        <x-inputs.text-area id="description" name="description"
          label="Description"
          placeholder="We are seeking a skilled and motivated Sofware Developer to join our growing development team"
        ...
        <x-inputs.text id="zipcode" name="zipcode" label="Zipcode"
          placeholder="02214" :value="old('zipcode', $job->zipcode)" />

        <x-inputs.text id="company_name" name="company_name"
